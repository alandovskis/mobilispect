package com.mobilispect.benchmark
...
import com.mobilispect.benchmark.frequency_commitment.frequencyCommitmentWaitForContent
...
abstract class AbstractStartupBenchmark(private val startupMode: StartupMode) {
    ...
    private fun startup(compilationMode: CompilationMode) = benchmarkRule.measureRepeated(
        packageName = "com.mobilispect.android",
        ...
        frequencyCommitmentWaitForContent()
    }
}